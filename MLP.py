...
#Retrieve training and test datum
X_train, y_train = load_mnist('mnist', kind='train')
X_test, y_test = load_mnist('mnist', kind='t10k')

#Visualize example of unique digits 0-9
...
#Visualize same digit with different handwriting
...
class NeuralNetMLP(object):
    ...
    def _sigmoid(self, z):
        return expit(z) #This is 1/[1 + np.exp(-z)]

    def _sigmoid_gradient(self, z):
        sg = self._sigmoid(z)
        return sg * (1 - sg) #This is the derivative of 1/[1 + np.exp(-z)]
